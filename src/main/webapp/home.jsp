...
<html>
	...
	<body>
		...
		<section class="awards sec-width" id="awards">
			<div class="topic">
				<h2>AWARDS</h2>
			</div>
			<div class="awards-container">
				<article class="award">
					...
					<div class="award-content">
						...
						<p>Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.</p>						<button type="button" class="btn">Know More</button>
					</div>
				</article>
				<article class="award">
					<div class="award-icon">
			...
			<div class="sec-width">
				...
				<div class="blogs-container">
					<div class="blog">
						...
						<p>Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas.</p>
						<img src="Pics/b-1.jpg">
						<span class="blog-name">Mukesh,Coimbature</span>
					</div>
					<div class="blog">
						<h3>Lorem ipsum dolor</h3>
						<p>Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas.</p>
						<img src="Pics/b-2.jpg">
						<span class="blog-name">Vidyakanth,India</span>
					</div>
					<div class="blog">
						<h3>Lorem ipsum dolor</h3>
						<p>Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas.</p>
						<img src="Pics/b-3.jpg">	
						<span class="blog-name">Alagesan, Tanjore </span>
					</div>
				</div>
			</div>
		</section>
