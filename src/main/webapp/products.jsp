...
<section class="products" id="products">
			...
			<nav class="pro">
                <a href="#oil"><button class="btn oilbtn active">Oil Products</button></a>
                <a href="#ghee"><button class="btn gheebtn" >Ghee Products</button></a>
                <a href="#chekku"><button class="btn chekbtn">Chekku Gingely</button></a>
                <a href="#sesame"><button class="btn sesbtn" >Sesame Products</button></a>
            </nav>
        </section>
        <section id="oil">
        <div class="container">
            <div class="grid">
                <article>
                    ...
                    <div class="text">
                        <h3>Lorem Ipsium</h3>
						<a href='payment.jsp'><button>Buy Now</button></a>
                    </div>
                </article>

                <article>
                    <img src="Pics/b.jpg" alt="">
                    <div class="text">
                        <h3>Lorem Ipsium</h3>
						<a href='payment.jsp'><button>Buy Now</button></a>
                    </div>
